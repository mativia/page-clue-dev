...
// Misma Access Key pública de Web3Forms que el resto del sitio.
      ...
      >
        <form className={styles.form} onSubmit={handleSubmit}>
          <div className={styles.formHeader}>
            ...
            <h2 className={styles.title}>{c.title}<span className={styles.dot}>.</span></h2>
          </div>

          <div className={styles.fieldRow}>
            <div className={styles.field}>
              <label htmlFor="d-nombre" className={styles.label}>{c.labels.nombre}</label>
              <input
                id="d-nombre" name="nombre" type="text"
                className={styles.input} value={fields.nombre}
                onChange={handleChange} required autoComplete="name"
              />
            </div>
            <div className={styles.field}>
              <label htmlFor="d-empresa" className={styles.label}>{c.labels.empresa}</label>
              <input
                id="d-empresa" name="empresa" type="text"
          ...
          <div className={styles.fieldRow}>
            <div className={styles.field}>
              <label htmlFor="d-rol" className={styles.label}>{c.labels.rol}</label>
              <input
                id="d-rol" name="rol" type="text"
                className={styles.input} value={fields.rol}
                onChange={handleChange} autoComplete="organization-title"
              />
            </div>
            <div className={styles.field}>
              <label htmlFor="d-email" className={styles.label}>{c.labels.email}</label>
              <input
          ...
          <div className={styles.field}>
            <label htmlFor="d-mensaje" className={styles.label}>{c.labels.mensaje}</label>
            <textarea
              id="d-mensaje" name="mensaje"
        ...
        <aside className={styles.aside}>
          ...
          <div className={styles.socials}>
            <a
              ...
              aria-label="Instagram" className={styles.social}
            >
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              aria-label="LinkedIn" className={styles.social}
            >
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <a
              ...
              target="_blank" rel="noopener noreferrer"
              aria-label="WhatsApp" className={styles.social}
            >
              <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
